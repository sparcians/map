...
Most modelers will not perform any explicit configurations at this
point, but at this point in simulation construction, the modeler can
grab the parameters that are associated with _any_ of the modeled
components to make adjustments, check for errors, etc.
