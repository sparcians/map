...
private:
    ...
    // Producer's ports
    sparta::SyncOutPort<uint32_t> producer_out_port_{&unit_port_set_, "producer_out_port", getClock()};
    sparta::SignalInPort          producer_go_port_ {&unit_port_set_, "producer_go_port", 1};
