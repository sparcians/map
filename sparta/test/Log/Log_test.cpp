...
int main()
{
    ...
    // Scope all of the tests
    {
        ...
        infos.clear();
        EXPECT_EQUAL(a.getPossibleSubtreeNotifications(infos), 2); // c_src_mycategory, d_scr_mycategory,
        ...
        // a_cats_wildcard.log
        EXPECT_EQUAL(sparta::log::DestinationManager::getNumDestinations(), 15);
