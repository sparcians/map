...
# Database
        ...
        self.toolbarAddElement = self.__edit_toolbar.AddTool(wx.NewId(), 'Add Element', wx.ArtProvider.GetBitmap(wx.ART_ADD_BOOKMARK), shortHelp = 'Add an element')
        ...
        self.toolbarDeleteElement = self.__edit_toolbar.AddTool(wx.NewId(), 'Delete Element(s)', wx.ArtProvider.GetBitmap(wx.ART_DEL_BOOKMARK), shortHelp = 'Delete selected element(s)')
